...
Consulta una [configuración de ejemplo](https://github.com/pgmoneta/pgmoneta/blob/0.21.0/doc/manual/es/etc/pgmoneta.conf) para ejecutar `pgmoneta` en `localhost`.
