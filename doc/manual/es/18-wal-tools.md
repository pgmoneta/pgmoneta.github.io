...
Para obtener información más detallada sobre las API internas y documentación del desarrollador, consulta la [Guía del desarrollador WAL](/doc/manual/es/78-wal).
