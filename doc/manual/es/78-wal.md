...
Este documento proporciona una descripción general de la implementación del WAL (Write-Ahead Log) reader, enfocándose en las APIs internas e interfaces para desarrolladores. Para documentación orientada al usuario sobre las herramientas WAL, consulta el [capítulo de herramientas WAL](/doc/manual/es/18-wal-tools).
